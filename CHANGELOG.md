...
- Scaffold Hank — Phase 1 CLI, tooling, docs([ea0f78b](https://github.com/scbrown/yupana/commit/ea0f78bd3ae44d5a2a0396dcc77d163438eb83e0))
...
- Hank #5 (file-watch) + #16 (doc→code refs) + #9 grammars (langs-extra) (#29)([5fc6749](https://github.com/scbrown/yupana/commit/5fc6749ba0f59da7c57aac3024b216bc07087030))
...
- *(verify)* Hank_verify monitor-guided edit verification (#19) (#33)([8a5d5f5](https://github.com/scbrown/yupana/commit/8a5d5f544e13dbd02090fe47aa4e44d3c05afbfb))
...
- *(status)* Make the policy layer observable in `hank status` (#45)([6cc696f](https://github.com/scbrown/yupana/commit/6cc696fab6ba7491c1cb0e417f58803d6092b739))
...
- *(mcp)* Hank_promote tool — the MCP surface of the promotion path (#15)([2d258cd](https://github.com/scbrown/yupana/commit/2d258cd50510b0a4ecd8c6cd9f2a1705566a3801))
...
- *(daemon)* Resident graph process + liveness surface + loud-absence seam (hank #1, stage 1) (#53)([0fc5843](https://github.com/scbrown/yupana/commit/0fc5843c09011451748bd75244ced04b47511283))
- *(daemon)* Graph-backed query endpoints over the resident graph (hank #1, stage 2) (#55)([e4c0cb3](https://github.com/scbrown/yupana/commit/e4c0cb380c68e13b129b7386c0915b34c58e1fd6))
- *(daemon)* Resident-graph edit measurement + /measure endpoint (hank #1, stage 3a) (#56)([a3c2c30](https://github.com/scbrown/yupana/commit/a3c2c30a94a45e61b9b05e71fedd2046693f982c))
- *(hook)* Pre-edit guard is a thin client of the resident daemon (hank #1, stage 3b) (#57)([14313f6](https://github.com/scbrown/yupana/commit/14313f630a981267e434aa7048d228020c8a69aa))
...
- *(mcp)* MCP graph tools are thin clients of the resident daemon (hank #1, stage 3c) (#58)([2d2e0cc](https://github.com/scbrown/yupana/commit/2d2e0cc2e62467cf84fb70559e07e72c717168fa))
...
- *(census)* Hank census — count same-file symbol-name collisions at the only layer that can see them([900062a](https://github.com/scbrown/yupana/commit/900062a2043e969c47a8a477e5eb5a848c1758f4))
...
- *(daemon)* Complete the FR-27 query surface — /references, /symbols, /dataflow (hank #1, stage 4) (#65)([a58467b](https://github.com/scbrown/yupana/commit/a58467b871beaeac7ed1c0dcd9b73bf83168f234))
- *(daemon)* Post-edit thin client + graceful shutdown + wire-level SLO test — closes hank #1 (stage 5) (#66)([15756f1](https://github.com/scbrown/yupana/commit/15756f15b886d935162930cedb797ec9a0b2f912))
- *(graph)* Shared read-only base + CoW per-tenant overlays (hank #2, slices 1+2+4) (#67)([67dcbba](https://github.com/scbrown/yupana/commit/67dcbba33c9b0e124f43b3f179032243ae7bb29c))
- *(daemon)* Wire the tenant layer live — /edit feed, tenant-scoped queries, status overlays (hank #2 close) (#68)([fcd6958](https://github.com/scbrown/yupana/commit/fcd6958121f056f0fe1fae5014a13f0f408001ef))
- *(graph)* Frontier-bounded overlay update + overlay-new-name resolution (hank #3, FR-16) (#69)([a298521](https://github.com/scbrown/yupana/commit/a2985215ca7035c8f7e5ff0b17b82dfb5280098c))
- *(graph)* Content-hash structural sharing — base-hit no-op + sharing stats (hank #4, FR-15) (#70)([2a66389](https://github.com/scbrown/yupana/commit/2a66389931255b5132547c25e85b0a65b99c12a9))
- *(watch)* File-watch drives per-tenant overlays via the frontier recompute (hank #5, FR-17) (#71)([00898b7](https://github.com/scbrown/yupana/commit/00898b7e84d2e74c755a65cd445e8092511ea930))
- *(graph)* Overlay lifecycle + eviction + high-fan-in guard — completes Phase 3 (hank #6, FR-18) (#72)([8cb823f](https://github.com/scbrown/yupana/commit/8cb823fbc349d93074e3b2ef91d8595dba62d905))
- *(promote)* Read the committed tree, not the working tree — FR-22 + arbitrary --commit (hank #15 slice) (#73)([12a1529](https://github.com/scbrown/yupana/commit/12a1529536671d4813cd2cfe26b4a58ca62e3943))
...
- Replace code graph snapshots atomically([d946bd3](https://github.com/scbrown/yupana/commit/d946bd32da068313b6e8abb2e970a0882b6bef4b))
- Add tier to PromoteResponse, verify arm in pre-edit guard, freshness docs([0245984](https://github.com/scbrown/yupana/commit/024598475a0218a62366cdcf5f0294f2267b0e83))
- Drive the FR-16 frontier recompute from the daemon edit path([893623a](https://github.com/scbrown/yupana/commit/893623aaa9b5aa10b9d83aad41a758e9309ec447))
- Entity-grounded rule plane — work-item grounding set in the hot plane([9e73bff](https://github.com/scbrown/yupana/commit/9e73bff79bd7058a8d5eafe3e497857444d6f0e9))
- Denied-edit recurrence advisory — the verdict spool as a similarity corpus([4b6e8a6](https://github.com/scbrown/yupana/commit/4b6e8a67bcc005bd9527b6bc3a68545b32408dc5))
- Yupana exemplar — Selector + tiered predicate candidates from an observed edit([23fee46](https://github.com/scbrown/yupana/commit/23fee46a530ed0cb4fc98bbb4e781e08c8436660))
- Work-item scope isolation — the provenance ladder's observed rung([bf13cbb](https://github.com/scbrown/yupana/commit/bf13cbb43505d24e17a0b8f45c365acd8c81f122))
- Assignment-time work-item briefing — context before the first mistake([2acdb14](https://github.com/scbrown/yupana/commit/2acdb148adafe5b7bea1cc118100bb1f371f7d3c))
- Briefing retrieval eval (F1 + ablation), no cross-tool duplication([fe906cf](https://github.com/scbrown/yupana/commit/fe906cf0734bcca466b7416bc7686a51f83409fd))
- *(brief)* Corroboration-scored similarity — macro-F1 0.87 -> 0.94([7d8bbe1](https://github.com/scbrown/yupana/commit/7d8bbe1c756e54f029139f376c87be45a513d9e2))
- *(eval)* Problem-class F1 corpus + hub-degree cap on co-occurrence([8a9cf79](https://github.com/scbrown/yupana/commit/8a9cf7971118af38ab5e450b414680e4fea5c859))
- *(brief)* Semantic retrieval arm — model provisioning workaround + query-relative support([ed49faa](https://github.com/scbrown/yupana/commit/ed49faa47b88a7a32d635295a20cfde61d30c745))
- *(state)* `replace` on ingest, so a world view can BE the board([a0bbd1e](https://github.com/scbrown/yupana/commit/a0bbd1e3ed49ab95c51896c41a0e1b0aab3e2a6d))
- *(daemon)* Serve code-fact freshness on /symbols (bobbin-052)([7d6e725](https://github.com/scbrown/yupana/commit/7d6e7254464575607b322b078f322c46532ad8f8))
- *(trace)* The guard record says whether it parsed, and which work item([8590e76](https://github.com/scbrown/yupana/commit/8590e761cb9e6822fb3edb60f21789cd4740b1a6))
- *(scope)* Deliver the advise-rung notice where the agent can read it([b463dad](https://github.com/scbrown/yupana/commit/b463dad50a202f8623e624b44ee9a972f699e13a))
- *(brief)* Session-start pushes L0 plus a census of what it held back([a75e72b](https://github.com/scbrown/yupana/commit/a75e72bad77079ce3a14c83cb91b8a624d744707))
- *(scope)* The deviation notice carries what the graph knows about where you went([4fe4a57](https://github.com/scbrown/yupana/commit/4fe4a57fec677c6c07031f78231149afb6b5aff4))
- *(scope)* The derived rung — an item with no ground inherits its parent's([b47004b](https://github.com/scbrown/yupana/commit/b47004bace7005f3807963048e361e13ff00aeef))
- *(action)* The Bash surface can refuse, staged off([a87b7a1](https://github.com/scbrown/yupana/commit/a87b7a10c00fdb8de060645cde0db0d5876a0f0f))
- *(replay)* The promotion gate the spool can finally feed([64b6b80](https://github.com/scbrown/yupana/commit/64b6b802c2a65b40f5383eb26e76947d1d33222b))
- *(goldenpath)* The golden-path conformance guard (FR-40..FR-42)([3014f62](https://github.com/scbrown/yupana/commit/3014f62f9995af5cbb9ae853cf19064e9f1849c5))
- *(policy)* Tripwires — local Binding/Gate declarations at the pre-edit guard([b740ea4](https://github.com/scbrown/yupana/commit/b740ea43726d0d5d386c6ab00fa7d71ca76e345a))
- *(policy)* Governed tripwires — project quipu's path-boundary policies([9b736fa](https://github.com/scbrown/yupana/commit/9b736fa9e0b5eb9d93d4ce136eccafd6215751d2))
- Bind turn-grounding evidence into traces([f2b4f4f](https://github.com/scbrown/yupana/commit/f2b4f4f9a9b53ec5e746c9dee9b6bc33deaf5cf5))
- *(promote)* Honor promote_on — wire the commit/merge promotion trigger([b484326](https://github.com/scbrown/yupana/commit/b484326e1f2b9cf52bdfad631f13f2aec2a42b49))
- *(promote)* §9.4 branch modeling — the qualifier fallback, and a loud refusal([4fc1558](https://github.com/scbrown/yupana/commit/4fc15580226e235d825b144d3f90e3859c7bb961))
- *(promote)* §9.7 commit→touched-entities provenance, produced inside yupana([33d0046](https://github.com/scbrown/yupana/commit/33d0046440396f6d488e0a857aaebea6c969c88d))
- Govern memory-heavy commands from graph policy([689f2c2](https://github.com/scbrown/yupana/commit/689f2c26df2ec7074077687f3a675ca698f3f87c))
...
- Pay down the file-size ratchet to green([2032fb1](https://github.com/scbrown/yupana/commit/2032fb199897dc1461819a5264b35bebf69df62b))

### Documentation

- Add Hank vision and build specification([41519e9](https://github.com/scbrown/yupana/commit/41519e9ef71e0f0db0d98671dab7e7090374b510))
- *(readme)* Named-competitor comparison + selling points + hank×quipu use-cases; reference the hank CLI (not cargo run)([18e813d](https://github.com/scbrown/yupana/commit/18e813df8e091e4a9bb5917b28aed13efb97335a))
...
- Catch the README and book up to the recently landed planes([517021d](https://github.com/scbrown/yupana/commit/517021db52ed517440df6ab8f54bc928299e0160))
- FR-3 code-fact freshness is served, not merely tracked([ea87ca4](https://github.com/scbrown/yupana/commit/ea87ca4911f68006dc686f45d32619b8eb493097))
- Regenerate Appendix D from the tree, and pin it so it cannot rot silently([544265f](https://github.com/scbrown/yupana/commit/544265fc8657e9d0f9214942cf98142d16c59fde))
- Describe live policy engine status([8e3dcc3](https://github.com/scbrown/yupana/commit/8e3dcc35311b1d48b6069c67c577467219e2fd3b))
- Code slices as Quipu share bundles, and the two traps in the pipeline([74d6a6e](https://github.com/scbrown/yupana/commit/74d6a6e6572d06e193034b8700d557249cd70517))

### Fixed

- *(policy)* A stale hank must not block every edit in the fleet (#35)([e38b5b8](https://github.com/scbrown/yupana/commit/e38b5b8288f3fb32da7429a22c47350a6ebbc3f3))
...
- *(policy)* Traverse text rule subclasses([aee6beb](https://github.com/scbrown/yupana/commit/aee6bebc7daf061c7b0b5b4faa657ff21c272dd6))
- *(project)* Carry aegis:appliesTo, so a scoped policy stays scoped([35ebc90](https://github.com/scbrown/yupana/commit/35ebc90577c6c60cca979ba2763a722e65455a41))
- *(ci)* Satisfy current clippy lint([b7a1669](https://github.com/scbrown/yupana/commit/b7a16694e332a3738a887e838b94f5dc2b8878b6))
- *(policy)* Dedupe exact advisory rationales([9e67463](https://github.com/scbrown/yupana/commit/9e674635e0d3ad4cc899c002533c1a89cca52290))
- *(hook)* Bound and isolate fail-open markers([4cdcbd7](https://github.com/scbrown/yupana/commit/4cdcbd7cdee78b12be10121206cec170eebf85b9))
- *(ci)* Clear the four pre-existing Clippy (mcp+quipu) errors([25fa483](https://github.com/scbrown/yupana/commit/25fa4830a51c2e2696284494f9d59528e32cc5d5))
- *(config)* The phased-key exemptions cited a blocker that does not exist([baa9d82](https://github.com/scbrown/yupana/commit/baa9d82718c14d42065f25176df79a962b926e92))
- *(install)* Unify yupana and hank executable names([6801ac6](https://github.com/scbrown/yupana/commit/6801ac63e6918b44a93f5fb88edf63f9c7c087ec))
- *(config)* Preserve legacy hank tables after rename([4079898](https://github.com/scbrown/yupana/commit/40798982c767b25cbdec31226948008df6b5dff8))
- *(export)* Announce the directory-name identity guess([4f57801](https://github.com/scbrown/yupana/commit/4f57801a6115547312f06f6622aff77702f4e3f8))
- *(ci)* Track project memory namespace carrier([26a107f](https://github.com/scbrown/yupana/commit/26a107fc51e8c4f0cab4ae0d5a1bd5dc03575ba7))
- *(impact)* Expose ambiguous symbol definitions([2fe1b6b](https://github.com/scbrown/yupana/commit/2fe1b6b903fb00091114bf90658793461d564b0a))
- *(verify)* Count newly added call occurrences([a37e7fe](https://github.com/scbrown/yupana/commit/a37e7fef693413a55cae6ff6b02794cba1891137))
- *(verify)* Mask replaced file definitions([1660e12](https://github.com/scbrown/yupana/commit/1660e128f5789bfbc9ddf4e3903fdb14cf72cd8c))
- Resolve stale yupana triage gaps (#7 #10)([4457c24](https://github.com/scbrown/yupana/commit/4457c2444115eca14b4550c0ff61bafc2876edaa))
...
- *(release)* V0.4.0([9a2dca4](https://github.com/scbrown/yupana/commit/9a2dca4025c6c06e06debf5bad1a5cdd9cb52b00))
- *(release)* Sync Cargo.lock to 0.4.0([b19ca9b](https://github.com/scbrown/yupana/commit/b19ca9b939a510b3a7fbf0967847b1867bbe44d3))
- Release v0.5.0 (#89)([0ba49d8](https://github.com/scbrown/yupana/commit/0ba49d8732cb2491fc63e57daab4021926b9dc1f))
- Release v0.6.0([9b5628f](https://github.com/scbrown/yupana/commit/9b5628fda529f093d18b3f6792ded54df99f339c))
- [**breaking**] Rename the project from hank to yupana([6eeb35f](https://github.com/scbrown/yupana/commit/6eeb35f2267ba77d192c429de3dc9aa03c6e37ef))

### README

- The top matter said code structure and omitted the policy engine([e9b6680](https://github.com/scbrown/yupana/commit/e9b6680f720ad57b196071ed014cc723ae0fa502))
...
- Cargo-invoked processes must not write hank's REAL state([b95525c](https://github.com/scbrown/yupana/commit/b95525c34b35fd014e13e0a731d5b52f9a2a6dd5))
...
- Allow the e2e harness in the ontology-namespace carrier list([06906a0](https://github.com/scbrown/yupana/commit/06906a07791beb6093b6dfd7fc396db1bc2b04b9))
...
- Fmt fallout from the rename([d04ca9f](https://github.com/scbrown/yupana/commit/d04ca9f8ddd124a78e5901ba2555445e5b88fd8b))
- Rustfmt, clippy and markdownlint cleanup for the grounding batch([0f1583d](https://github.com/scbrown/yupana/commit/0f1583da31beebf3aa41a0779027a8d5b4d3788e))
