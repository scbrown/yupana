...
- *(disk-guard)* Read disk history in subject-bound single-pattern hops([1aad054](https://github.com/scbrown/yupana/commit/1aad054aeca36aec679562485531f09f5334c867))
- *(disk-guard)* Cap disk history to the NEWEST observations before any hop([6361b52](https://github.com/scbrown/yupana/commit/6361b523087045fdc4fbbe41a45fe27ce34ab4b9))
...
- *(hook)* Resolve a post-edit advisory against the edited file's own repo([37caea5](https://github.com/scbrown/yupana/commit/37caea50bcf115ff82c7000709a18f2b0b6481e2))
...
- *(brief)* Walk provenance in subject-bound single-pattern hops([9ae7762](https://github.com/scbrown/yupana/commit/9ae776201bb129e3457334e857ce40560cff5461))
- *(brief)* Say so when a provenance hop truncates at MAX_WIDTH([8646575](https://github.com/scbrown/yupana/commit/86465751ae354b9334dfedc9ae6ad27d2c884f26))
...
- *(cli)* `yupana rule-test` runs governed rule cases through the guard's engine([d314643](https://github.com/scbrown/yupana/commit/d314643fd4cb9f71da9d709b2ce40f43710b7f51))

### Documentation

- Newcomer-first README, the book as the docs home, links checked([e5caad2](https://github.com/scbrown/yupana/commit/e5caad28e4edf702678bfb609dd231834262c41e))
- *(readme)* Conform to the stack README standard (caboodle PR #18)([15ca77b](https://github.com/scbrown/yupana/commit/15ca77bdb42210a1da5786d03b81ef29c18c0eca))
- *(readme)* State the fifteen yupana_* MCP tools (docs_drift pins the count)([9f499cb](https://github.com/scbrown/yupana/commit/9f499cba5bbacb4cbb64a0b30382cce8fb22d15c))

### Fixed

- *(guard)* Label a file outside any work tree `unversioned`, not `unknown`([e7d3f8a](https://github.com/scbrown/yupana/commit/e7d3f8a18e1d02095dacf8b7e81a7e16f9b22d5b))
- *(guard)* Label a tree with no remotes `no-remotes`, distinct from `no-origin`([4457c83](https://github.com/scbrown/yupana/commit/4457c832019bcb8ac84eaa4d63a0c86469e34524))
- *(scope-notice)* Ask the deviation source as single-pattern steps([fbc5c93](https://github.com/scbrown/yupana/commit/fbc5c9386b8acb86434f7a26962e1baf68e377fb))
- *(install)* Make install-local.sh work on stock macOS (#101)([56581e9](https://github.com/scbrown/yupana/commit/56581e9fbe4c962307aeb3519f190cdc98be3d78))

### Testing

- *(ratchet)* Allow hostnames and crew names in the public tree([2c5651f](https://github.com/scbrown/yupana/commit/2c5651fa196f328f799c539898a38532f0147e37))

### License

- Relicense from MIT to Apache-2.0 (express patent grant) (#94)([977df9e](https://github.com/scbrown/yupana/commit/977df9e109b3375e30be4634d8e79e9e810ebff4))
...
- *(textrules)* Aegis:exemptRepo and aegis:exemptLineMarker([6d16bff](https://github.com/scbrown/yupana/commit/6d16bffcb1215ad9ba9d3fbb8bc40f4b3dd97d71))

### Fixed

- *(grounding)* Project the work-item id set as two queries, intersected client-side([c9f0493](https://github.com/scbrown/yupana/commit/c9f04936d29eb28689c355a10e7e3a728bb0b9c4))
- *(serve)* A build without `mcp` fails serve and daemon with exit 2, never 0([4e68b94](https://github.com/scbrown/yupana/commit/4e68b94bf232b5c424cfb316476c7564a8b40514))
- *(grounding)* Read camayoc's crew-records plane as well as the default graph([d42fd80](https://github.com/scbrown/yupana/commit/d42fd80f1ad96dd5f094f97eb3f4b6fcf4ff4dc6))
...
- Yupana is a counting board, not a skein — drop the hank-era yarn metaphor and the bad Wikipedia link([0198750](https://github.com/scbrown/yupana/commit/0198750ed46d77002581888390495703a1ada3d9))
...
- *(project)* Split the projection budget into its own module([f08e9db](https://github.com/scbrown/yupana/commit/f08e9db043f1f29670885866eea55c27919fbb2e))

### Fixed

- *(landing)* Make owner_only exhaustive — the permissive answer was the default([2a079de](https://github.com/scbrown/yupana/commit/2a079de21695e0c3c74222504ab093633d86fd8a))
- *(test)* Gate the owner-gate test on the quipu feature([d2a750d](https://github.com/scbrown/yupana/commit/d2a750d21c526f86fd1c9f7f34ce8cb95ca927dc))
- *(test)* Make the owner-gate test pass CI's own clippy invocation([fcdd777](https://github.com/scbrown/yupana/commit/fcdd7776c3eebafc5c6ffe1b74ce482f27521958))
- *(hook)* Bound the TOTAL projection budget, not just each call([4702407](https://github.com/scbrown/yupana/commit/47024070f4fb22469327d2601f6214315584c1a4))
- *(test)* Gate the projection-budget test on the quipu feature([04f5f77](https://github.com/scbrown/yupana/commit/04f5f777976ce1a15d65600b3a6684500f177cfc))
- *(test)* Allow the shouting test-name convention (clippy -D warnings)([8cc175d](https://github.com/scbrown/yupana/commit/8cc175d6388f6592f1b06d4bdbef0df97d1214b3))
...
- *(landing)* Put the acting agent in the spool record key (#76)([1d1ec69](https://github.com/scbrown/yupana/commit/1d1ec69ac9b608223d098dc918c5a80669f6edd0))
- *(landing)* Resolve Forgejo REST merges, which the policy could not see (#78)([645eabe](https://github.com/scbrown/yupana/commit/645eabe7494ece32c4ebbf4fca2e9b31b1ef3a49))
...
- *(policy)* Resolve shared path exemption selectors (#73)([13f99fd](https://github.com/scbrown/yupana/commit/13f99fdd0ee1a0dd24ba7a3527137e11e07ea897))
- *(landing)* Model the tier-lead override as graph data (#75)([9aeff1a](https://github.com/scbrown/yupana/commit/9aeff1ad9843dd2d2d59b070d3fbee361e0914cf))
...
- *(lsp)* Capture raw responses on warm-query failures (#60)([cb0f49e](https://github.com/scbrown/yupana/commit/cb0f49ec1ddf42b1832580d2a5e799e33bbc212a))
- Synchronize real LSP workspace and saved-content assertions (#72)([5fb81f6](https://github.com/scbrown/yupana/commit/5fb81f6a61c6ff5d4b361cb18452e24cbaca6004))
...
- *(hook)* Extract text_plane rather than raise its size baseline([31bff26](https://github.com/scbrown/yupana/commit/31bff2652c8c257c0a728bc01a6ba1dd70abdecd))
...
- Batch briefing candidate identity queries (#64)([c1d781f](https://github.com/scbrown/yupana/commit/c1d781fcf))
...
- *(guard)* The exposure integration test encoded the OLD policy([4a5b67c](https://github.com/scbrown/yupana/commit/4a5b67ca22b3981c0847786335ff74969460d331))
...
- Complete reusable LSP precision sessions([942fb99](https://github.com/scbrown/yupana/commit/942fb991be330d2ded88ab275968714030099bf9))
- Add Rust CPG control dependence and interprocedural flow([8debe5e](https://github.com/scbrown/yupana/commit/8debe5efe9a26ba0487d432058aa132477be3498))
- *(promote)* Preserve commit valid time and committer provenance (#61)([85b85b0](https://github.com/scbrown/yupana/commit/85b85b0d986ddbfe06ce2471f150f4d97ae79601))
- *(guard)* Degrade a failed exposure lookup to LAST-KNOWN, not to allow (#63)([85d6b27](https://github.com/scbrown/yupana/commit/85d6b273cc6e0695bdaea639f394ab78f3689514))

### Fixed

- Bound governed policy projection reads([3c27703](https://github.com/scbrown/yupana/commit/3c27703153fe0fc70e23d86da7f47dc999172831))
- Satisfy projection feature lint checks([f4343ba](https://github.com/scbrown/yupana/commit/f4343ba97660767e3e5ef2fd66de7ab944130290))
- Separate cold LSP capability startup from warm requests([e25b48c](https://github.com/scbrown/yupana/commit/e25b48cc4cc39260819e1963f0b86c71050def38))
- Distinguish capability warmup and require real LSP CI coverage([f13059a](https://github.com/scbrown/yupana/commit/f13059a021b16a46ef1e9f72905d39db97a8ea3b))
- *(attestation)* Serialize concurrent action spool transactions (#58)([75a9ff7](https://github.com/scbrown/yupana/commit/75a9ff7bfa8fcbeca52ed366c764119fc2582caf))
- *(policy)* Distinguish unknown work-item plates from empty ones (#59)([8925834](https://github.com/scbrown/yupana/commit/8925834e60cf47a88a20712f29270cecfa52babb))
- *(guard)* Record WHETHER we got an exposure answer, not only what it was (#62)([1e84ad2](https://github.com/scbrown/yupana/commit/1e84ad29b81df7885509d6be77a50ad7ef700020))
...
- *(policy)* Governed landing policy — single-writer as graph data([8257c7e](https://github.com/scbrown/yupana/commit/8257c7e61f4c2a9f4541c420f5b373c35e5e23c3))
- *(hook)* The DELEGATE line — advise when a bead was filed and edits continue([a879be5](https://github.com/scbrown/yupana/commit/a879be545a8aca731475307808fc08fb1f8639ec))
- Project session trajectory advice from governed policies (#34)([4045139](https://github.com/scbrown/yupana/commit/4045139128cd1f984493ae4d7f72659cbc05fc81))
- *(share)* `yupana share` — pull a Quipu share, preview its policy, admit it([9e89d64](https://github.com/scbrown/yupana/commit/9e89d6494305685eb4635a6927057545d3a80cd3))
- *(share)* Add `share align`, and split the module under the size limit([6a15e9e](https://github.com/scbrown/yupana/commit/6a15e9e78b045eb940a78f79ec1ebe2d8a097d1b))
- *(share)* `share reshare` — a pulled graph goes back out as a delta([7bfc251](https://github.com/scbrown/yupana/commit/7bfc2513d942cec3ff27aecca86d591e62b176bb))
- *(context)* Advise from harness depth and preserve unknown signal state([e1c7cd2](https://github.com/scbrown/yupana/commit/e1c7cd234471ea9d6f37b56edaf3661767d9d0aa))
- Advise on repeated completed reads in the live hook([a1a5e90](https://github.com/scbrown/yupana/commit/a1a5e905fa2fdd5adf9b9049ba55b0342eedcfe7))
- *(hook)* Distinguish missing reread evidence at hook time([cf39782](https://github.com/scbrown/yupana/commit/cf397824a44875520ab18bf00a9e38fd8e1301a9))

### Changed

- *(hook)* Move three files' inline tests into `_test.rs`, under the ratchet([661193e](https://github.com/scbrown/yupana/commit/661193ed491604871d151492e12541ca80e4a671))

### Fixed

- *(policy)* A projection cache predating the landing plane is UNKNOWN([148e08a](https://github.com/scbrown/yupana/commit/148e08a5c7c26760017745bfaac810b4fa952b2c))
- Satisfy the feature-matrix clippy the local gate cannot see([84ebfb5](https://github.com/scbrown/yupana/commit/84ebfb51bdde04150d43919bf5286b65c63b4d92))
- *(policy)* The landing spool and key must not resolve against the cwd([f09d7cf](https://github.com/scbrown/yupana/commit/f09d7cfcdbd10192b9d4751c35d144035ddc5f9e))
- *(policy)* Resolve a remote name in the directory the command moved to([c644251](https://github.com/scbrown/yupana/commit/c644251e5806e109dcdcf16b08d091f599a69a50))
- *(hook)* Retain recent reread evidence in long sessions([a69b229](https://github.com/scbrown/yupana/commit/a69b229d4465e9e5da76aa5aa0abaa13db05ed76))
- *(hook)* Retry snapshots awaiting current Read persistence([7cf15d9](https://github.com/scbrown/yupana/commit/7cf15d9f5a505a47b2c21176650ee2c44da1561b))

### Daemon

- Cache repo exposure per (repo, rule-set hash) — the constant half of the guard's quipu load([21c7e5e](https://github.com/scbrown/yupana/commit/21c7e5e70a6d2f6a303e9892379129e5031b9140))
- Give /exposure its own client budget — the projection's would make a MISS worse than no cache([5056fd8](https://github.com/scbrown/yupana/commit/5056fd86c4cbe13098f7d9e528727ce42567307e))
...
- Refuse the unretractable append path (#51)([74a3dea](https://github.com/scbrown/yupana/commit/74a3dea6f6c06c766f91c8003b54b0c4b0cda2be))

### Quipu

- Label the CLI per verb, so the load can be attributed([50cd628](https://github.com/scbrown/yupana/commit/50cd6287bdb807490439511484c7f49df9731344))

### Spool

- Carry the matched token on the governed record (#31)([cc21ac0](https://github.com/scbrown/yupana/commit/cc21ac09d9b7084beb5d7171c9f84dbcbb04e78d))
